...
PS2용 **파이널 판타지 10 인터내셔널**을 한국어 비공식 번역 프로젝트입니다.
...
* **일본어 음성 버전 (실험 버전)**: 한국어 자막과 일본어 음성을 사용하며, 주요 인물의 이름이 한글로 저장됩니다.
...
* 패치 이전 롬 파일 기준의 세이브 파일 호환을 보장하지 않습니다. 되도록 새로운 게임으로 플레이하시기를 권장합니다.
