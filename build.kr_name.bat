...
set build_dir=build
set build_target_dir=!build_dir!\kr_name
set files=!build_target_dir!\files

set input_iso=base.iso
set target_iso=ffx_international_kr.kr_name.iso
set target_patch=ffx_international_kr.kr_name.xdelta

set target_name=kr_name
set multilang=0
